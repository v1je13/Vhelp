...
app.use('*', async (c, next) => {
  ...
  c.header('Access-Control-Allow-Headers', 'Content-Type, Authorization, X-VK-Sign, X-Requested-With, Accept, Origin, Cache-Control, Pragma');
  c.header('Access-Control-Allow-Credentials', 'true');
  c.header('Access-Control-Max-Age', '86400');
  c.header('Vary', 'Origin');
  
  // УБРАТЬ агрессивный Cache-Control — он ломает мобильные прокси Android
